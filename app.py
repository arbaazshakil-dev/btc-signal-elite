...
try:
    ...
    st.markdown(
        '<div style="font-size:18px;font-weight:700;margin-top:-8px;margin-bottom:8px;">ARBAAZ</div>',
    ...
    st.markdown(
        '<div style="text-align:center;opacity:.65;margin-top:24px;font-size:13px;">ARBAAZ • BTC Predictor Elite</div>',
        unsafe_allow_html=True
    )
