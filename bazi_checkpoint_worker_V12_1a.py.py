"""BAZI V12.1a checkpoint tracker for KXBTC15M.
...
def discover_and_predict():
    ...
    for market in data.get("markets", []):
        ...
        # DIAGNOSTIC: log every open market's remaining time as seen this pass,
        # to check whether markets ever appear "open" with >= 780s (13m) left.
        # Remove once the 13m-checkpoint investigation is resolved.
        print(f"DIAG seen ticker={market.get('ticker')} seconds_remaining={seconds}")
    ...
    for seconds, checkpoint, market, expiry in pending:
        ...
        payload = {
            ...
            "decision": decision,
            "features": features,
            "model_version": "v12.1a-checkpoint",
        }
