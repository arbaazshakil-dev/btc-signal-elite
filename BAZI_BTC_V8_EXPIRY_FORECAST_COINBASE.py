...
try:
    ...
    st.write(
        f"**FORECAST BTC AT EXPIRY:** ${target['forecast_price']:,.2f}"
    )
    st.write(
    ...
    st.caption(
        ...
        "V8 forecasts BTC at expiry from historical Coinbase features, then compares that future-price distribution with the target. It is probabilistic and not a guarantee of settlement or profit."
    )
